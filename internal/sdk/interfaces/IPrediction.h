...
public:
	void GetLocalViewAngles(  vec3_t &angle ) {
		...
		util::get_method( this, 12 ).as< original_fn >( )( this, angle );
	}

	void SetLocalViewangles(  vec3_t &angle ) {
		using original_fn = void( __thiscall *)( void *,  vec3_t & );
		util::get_method( this, 13 ).as< original_fn >( )( this, angle );
	}

	void Update( int start_frame, bool valid_frame, int inc_ack, int out_cmd ) {
		util::get_method( this, 3 ).as< void( __thiscall *)( void *, int, bool, int, int ) >
			( )( this, start_frame, valid_frame, inc_ack, out_cmd );
	}
	...
	void CheckMovingGround( IClientEntity *player, double frametime ) {
		...
		util::get_method( this, 18 ).as< fnCheckMovingGround >( )( this, player, frametime );
	}

	void SetupMove( IClientEntity *player, CUserCmd *ucmd, IMoveHelper *helper, void *movedata ) {
		util::get_method( this, 20 ).as< void( __thiscall*)( void *, IClientEntity *, CUserCmd *, IMoveHelper *, void * ) >
			( )( this, player, ucmd, helper, movedata );
	}

	void FinishMove( IClientEntity *player, CUserCmd *ucmd, void *movedata ) {
		util::get_method( this, 21 ).as< void( __thiscall*)( void *, IClientEntity *, CUserCmd *, void * ) >
			( )( this, player, ucmd, movedata );
	}
