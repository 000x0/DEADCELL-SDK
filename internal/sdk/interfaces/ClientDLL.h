...
public:
	ClientClass *GetAllClasses( ) {
		return util::get_method( this, 8 ).as<
			ClientClass *(__thiscall *)( decltype( this ) ) >( )( this );
	}
};
...
class IEngineClient {
public:
	virtual int GetIntersectingSurfaces( const model_t *model, const  vec3_t &vCenter, float radius,
	                                     bool bOnlyVisibleSurfaces, SurfInfo *pInfos, int nMaxInfos ) = 0;
