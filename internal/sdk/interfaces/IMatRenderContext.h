...
public:
	...
	virtual IMesh *CreateStaticMesh( VertexFormat_t fmt, const char *pTextureBudgetGroup, IMaterial *pMaterial = nullptr ) =
	0;
	...
	// Set a linear  vec3_t color scale for all 3D rendering.
	...
	virtual void SetScissorRect( int nLeft, int nTop, int nRight, int nBottom,
	                             bool bEnableScissor ) = 0;
	...
	template< class E >
	E *LockRenderDataTyped( int nCount, const E *pSrcData = nullptr );
