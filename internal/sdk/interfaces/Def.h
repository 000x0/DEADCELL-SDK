...
public:
	...
	RadianEuler(  vec3_t const &angles ); // evil auto type promotion!!!
	...
	//	conversion to  vec3_t
	 vec3_t ToVector( void ) const;
	bool IsValid( ) const;
	void Invalidate( );
...
public:
	...
	QuaternionAligned( float X, float Y, float Z, float W ) {
		Init( X, Y, Z, W );
	}
...
struct mstudiobone_t {
	...
	inline void *pProcedure() const { if( procindex == 0 ) return NULL; else return  ( void * )( ( ( ulong_t * )this ) + procindex ); };
...
struct studiohdr_t {
	...
	int					numbones;			// bones
	int					boneindex;
	inline mstudiobone_t *pBone( int i ) const { assert( i >= 0 && i < numbones ); return ( mstudiobone_t * )( ( ( ulong_t * )this ) + boneindex ) + i; };
	int					RemapSeqBone( int iSequence, int iLocalBone ) const;	// maps local sequence bone to global bone
	int					RemapAnimBone( int iAnim, int iLocalBone ) const;		// maps local animations bone to global bone

	int					numbonecontrollers;		// bone controllers
	int					bonecontrollerindex;
	inline mstudiobonecontroller_t *pBonecontroller( int i ) const { assert( i >= 0 && i < numbonecontrollers ); return ( mstudiobonecontroller_t * )( ( ( ulong_t * )this ) + bonecontrollerindex ) + i; };
	...
	mstudiohitboxset_t	*pHitboxSet( int i ) const
	{
		...
		return ( mstudiohitboxset_t * )( ( ( ulong_t * )this ) + hitboxsetindex ) + i;
	};
	...
	int					numcdtextures;
	int					cdtextureindex;
	inline char			*pCdtexture( int i ) const { return ( ( ( char * )this ) + *( ( int * )( ( ( ulong_t * )this ) + cdtextureindex ) + i ) ); };

	// replaceable textures tables
	int					numskinref;
	int					numskinfamilies;
	int					skinindex;
	inline short		*pSkinref( int i ) const { return ( short * )( ( ( ulong_t * )this ) + skinindex ) + i; };
